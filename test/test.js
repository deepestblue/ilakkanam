...
QUnit.module("வினயினத்துப்பெயர்கள்", () => {
    ...
    QUnit.module("validவினயினத்துப்பெயர்கள்", () => {
        ...
        QUnit.test("இடு", t => {
            ...
            ["வாங்கு", "உயர்", "விழு", "கடி", "தின்", "உண்",].forEach(assertInvalid(t, "இடு",),);
        });
        QUnit.test("வா", t => {
    ...
    QUnit.module("With பிறவினய் forms", () => {
        ...
        QUnit.module("Rule11", () => {
            ...
            QUnit.test("கல", (t) => {
                const expected = new Map([
                    ["இனம்", "வாங்கு",],
                    ["ஏவல்வினய்முற்று", "கலக்கு",],
                    ["எதிர்மறய்வினய்முற்று", "கலக்கார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "கலக்கினார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "கலக்குகின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "கலக்குவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "கலக்க",],
                    ["இறந்தகாலத்துவினயெச்சம்", "கலக்கி",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "கலக்கிய",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "கலக்குகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "கலக்கும்",],
                    ["தொழிற்பெயர்", "கலக்குதல்",],
                ],);
                t.deepEqual(getForms("கல").get("பிறவினய்வடிவு"), expected,);
            },);
        },);
        QUnit.module("Rule12", () => {
            QUnit.test("காய்", (t) => {
