...
QUnit.module("getForms", () => {
    ...
    QUnit.module("With custom இனம்", () => {
        QUnit.module("பாரும் இருவும்", () => {
            QUnit.test("பார் இனத்தில் கல", (t) => {
                const expected = new Map([
                    ["இனம்", "பார்",],
                    ["ஏவல்வினய்முற்று", "கல",],
                    ["அல்வினய்முற்று", "கலவார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "கலத்தார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "கலக்கின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "கலப்பார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "கலக்க",],
                    ["இறந்தகாலத்துவினயெச்சம்", "கலத்து",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "கலத்த",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "கலக்கின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "கலக்கும்",],
                    ["தொழிற்பெயர்", "கலத்தல்",],
                ],);
                t.deepEqual(getForms("கல", "பார்",), expected,);
            },);
            QUnit.test("இரு இனத்தில் தோல்", (t) => {
                const expected = new Map([
                    ["இனம்", "இரு",],
                    ["ஏவல்வினய்முற்று", "தோல்",],
                    ["அல்வினய்முற்று", "தோலார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "தோன்றார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "தோற்கின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "தோற்பார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "தோற்க",],
                    ["இறந்தகாலத்துவினயெச்சம்", "தோன்று",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "தோன்ற",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "தோற்கின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "தோற்கும்",],
                    ["தொழிற்பெயர்", "தோற்றல்",],
                ],);
                t.deepEqual(getForms("தோல்", "இரு",), expected,);
            },);
        },);
        QUnit.module("உயரும் இயலும் சொல்லும்", () => {
            QUnit.test("இயல் இனத்தில் சொல்", (t) => {
                const expected = new Map([
                    ["இனம்", "இயல்",],
                    ["ஏவல்வினய்முற்று", "சொல்",],
                    ["அல்வினய்முற்று", "சொல்லார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "சொன்றார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "சொல்கின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "சொல்வார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "சொல்ல",],
                    ["இறந்தகாலத்துவினயெச்சம்", "சொன்று",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "சொன்ற",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "சொல்கின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "சொல்லும்",],
                    ["தொழிற்பெயர்", "சொல்லுதல்",],
                ],);
                t.deepEqual(getForms("சொல்", "இயல்",), expected,);
            },);
            QUnit.test("சொல் இனத்தில் வெல்", (t) => {
                const expected = new Map([
                    ["இனம்", "சொல்",],
                    ["ஏவல்வினய்முற்று", "வெல்",],
                    ["அல்வினய்முற்று", "வெல்லார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "வென்னார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "வெல்கின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "வெல்வார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "வெல்ல",],
                    ["இறந்தகாலத்துவினயெச்சம்", "வெல்லி",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["வென்ன", "வெல்லிய",],),],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "வெல்கின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "வெல்லும்",],
                    ["தொழிற்பெயர்", "வெல்லுதல்",],
                ],);
                t.deepEqual(getForms("வெல்", "சொல்",), expected,);
            },);
        },);
        QUnit.module("செய்யும் திண்னும் காணும்", () => {
            QUnit.test("செய் இனத்தில் தின்", (t) => {
                const expected = new Map([
                    ["இனம்", "செய்",],
                    ["ஏவல்வினய்முற்று", "தின்",],
                    ["அல்வினய்முற்று", "தின்னார்",],
                ...
                t.deepEqual(getForms("தின்", "செய்",), expected,);
            },);
            QUnit.test("செய் இனத்தில் காண்", (t) => {
                const expected = new Map([
                    ["இனம்", "செய்",],
                    ["ஏவல்வினய்முற்று", "காண்",],
                    ["அல்வினய்முற்று", "காணார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "காண்டார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "காண்கின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "காண்பார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "காண",],
                    ["இறந்தகாலத்துவினயெச்சம்", "காண்டு",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "காண்ட",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "காண்கின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "காணும்",],
                    ["தொழிற்பெயர்", "காண்டல்",],
                ],);
                t.deepEqual(getForms("காண்", "செய்",), expected,);
            },);
            QUnit.test("தின் இனத்தில் காண்", (t) => {
                const expected = new Map([
                    ["இனம்", "தின்",],
                    ["ஏவல்வினய்முற்று", "காண்",],
                    ["அல்வினய்முற்று", "காணார்",],
                ...
                t.deepEqual(getForms("காண்", "தின்",), expected,);
            },);
        },);
        QUnit.module("கடயுயிர்", () => {
            QUnit.test("போ இனத்தில் ஆ", (t) => {
                const expected = new Map([
                    ["இனம்", "போ",],
                    ["ஏவல்வினய்முற்று", "ஆ",],
                    ["அல்வினய்முற்று", "ஆகார்",],
                ...
                t.deepEqual(getForms("ஆ", "போ",), expected,);
            },);
            QUnit.test("போ இனத்தில் நோ", (t) => {
                const expected = new Map([
                    ["இனம்", "போ",],
                    ["ஏவல்வினய்முற்று", "நோ",],
                    ["அல்வினய்முற்று", "நோகார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "நோனார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "நோகின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "நோவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "நோக",],
                    ["இறந்தகாலத்துவினயெச்சம்", "நோய்",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "நோன",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "நோகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "நோகும்",],
                    ["தொழிற்பெயர்", "நோதல்",],
                ],);
                t.deepEqual(getForms("நோ", "போ",), expected,);
            },);
            QUnit.test("போ இனத்தில் சா", (t) => {
                const expected = new Map([
                    ["இனம்", "போ",],
                    ["ஏவல்வினய்முற்று", "சா",],
                    ["அல்வினய்முற்று", "சாகார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "சானார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "சாகின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "சாவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "சாக",],
                    ["இறந்தகாலத்துவினயெச்சம்", "சாய்",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "சான",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "சாகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "சாகும்",],
                    ["தொழிற்பெயர்", "சாதல்",],
                ],);
                t.deepEqual(getForms("சா", "போ",), expected,);
            },);
            QUnit.test("ஆ இனத்தில் போ", (t) => {
                const expected = new Map([
                    ["இனம்", "ஆ",],
                    ["ஏவல்வினய்முற்று", "போ",],
                    ["அல்வினய்முற்று", "போகார்",],
                    ...
                    ["எதிர்காலத்துவினய்முற்று", "போவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "போக",],
                    ["இறந்தகாலத்துவினயெச்சம்", new Set(["போய்", "போகி",],),],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["போன","போகிய",]),],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "போகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "போகும்",],
                    ["தொழிற்பெயர்", "போதல்",],
                ],);
                t.deepEqual(getForms("போ", "ஆ",), expected,);
            },);
            QUnit.test("ஆ இனத்தில் நோ", (t) => {
                const expected = new Map([
                    ["இனம்", "ஆ",],
                    ["ஏவல்வினய்முற்று", "நோ",],
                    ["அல்வினய்முற்று", "நோகார்",],
                    ...
                    ["எதிர்காலத்துவினய்முற்று", "நோவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "நோக",],
                    ["இறந்தகாலத்துவினயெச்சம்", new Set(["நோய்", "நோகி",],),],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["நோன","நோகிய",]),],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "நோகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "நோகும்",],
                    ["தொழிற்பெயர்", "நோதல்",],
                ],);
                t.deepEqual(getForms("நோ", "ஆ",), expected,);
            },);
            QUnit.test("ஆ இனத்தில் சா", (t) => {
                const expected = new Map([
                    ["இனம்", "ஆ",],
                    ["ஏவல்வினய்முற்று", "சா",],
                    ["அல்வினய்முற்று", "சாகார்",],
                    ...
                    ["எதிர்காலத்துவினய்முற்று", "சாவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "சாக",],
                    ["இறந்தகாலத்துவினயெச்சம்", new Set(["சாய்", "சாகி",],),],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["சான","சாகிய",]),],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "சாகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "சாகும்",],
                    ["தொழிற்பெயர்", "சாதல்",],
                ],);
                t.deepEqual(getForms("சா", "ஆ",), expected,);
            },);
            QUnit.test("நோ இனத்தில் போ", (t) => {
                const expected = new Map([
                    ["இனம்", "நோ",],
                    ["ஏவல்வினய்முற்று", "போ",],
                    ["அல்வினய்முற்று", "போகார்",],
                    ["இறந்தகாலத்துவினய்முற்று", "பொந்தார்",],
                    ["நிகழ்காலத்துவினய்முற்று", "போகின்றார்",],
                    ["எதிர்காலத்துவினய்முற்று", "போவார்",],
                    ["எதிர்காலத்துவினயெச்சம்", "போக",],
                    ["இறந்தகாலத்துவினயெச்சம்", "பொந்து",],
                    ["இறந்தகாலத்துப்பெயரெச்சம்", "பொந்த",],
                    ["நிகழ்காலத்துப்பெயரெச்சம்", "போகின்ற",],
                    ["எதிர்காலத்துப்பெயரெச்சம்", "போகும்",],
                    ["தொழிற்பெயர்", "போதல்",],
                ],);
                t.deepEqual(getForms("போ", "நோ",), expected,);
            },);
        },);
        QUnit.module("அடிப்படய்", () => {
        },);
