...
QUnit.module("வினயினத்துப்பெயர்கள்", () => {
    ...
    QUnit.module("validவினயினத்துப்பெயர்கள்", () => {
        ...
        QUnit.test("இயல்", t => {
            ...
            ["வாங்கு", "போ", "அணி",].forEach(assertInvalid(t, "இயல்",),);
        });
        QUnit.test("சொல்", t => {
        ...
        QUnit.test("தின்", t => {
            ...
            ["வாங்கு", "உயர்", "விழு", "கடி", "பெறு", "தொடு", "கல்", "கல",].forEach(assertInvalid(t, "தின்",),);
        },);
        QUnit.test("காண்", t => {
