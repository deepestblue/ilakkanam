        ...
        QUnit.module("வாங்குவும் போதுவும்", () => {
            QUnit.test("நம்பு", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["நம்பிய",],),],
            ...
            QUnit.test("உலாவு", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["உலாவிய",],),],
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["உலாத்திய",],),],
            ...
            QUnit.test("நில்", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["நிறுத்திய",],),],
            ...
            QUnit.test("வாழ்", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["வாழ்த்திய",],),],
            ...
            QUnit.test("செல்", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["செலுத்திய",],),],
                ...
                const expected = new Map([
                    ...
                    [causativeFormsKey, [
                        new Map([
                            ...
                            ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["ஊட்டிய",],),],
            ...
            QUnit.test("தின்", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["தீற்றிய",],),],
                ...
                const expected = new Map([
                    ...
                    [causativeFormsKey, [
                        new Map([
                            ...
                            ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["காட்டிய",],),],
            ...
            QUnit.test("போ", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["போக்கிய",],),],
            ...
            QUnit.test("ஆ", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["ஆக்கிய",],),],
            ...
            QUnit.test("இடு இனத்தில் படு", t => {
                const expected = new Map([
                    ...
                    [causativeFormsKey, new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["படுத்திய",],),],
        ...
        QUnit.module("Rule10", () => {
            QUnit.test("நட", t => {
                const expected = [
                    new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["நடத்திய",],),],
            ...
            QUnit.test("நீள்", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["நீட்டிய",],),],
        ...
        QUnit.module("Rule11", () => {
            QUnit.test("அடு", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["அடுக்கிய",],),],
            ...
            QUnit.test("காய்", t => {
                const expected = [
                    ...
                    new Map([
                        ...
                        ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["காய்ச்சிய",],),],
        ...
        QUnit.module("Rule13", () => {
            QUnit.test("பர", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["பரப்பிய",],),],
        ...
        QUnit.module("Rule30", () => {
            QUnit.test("ஆடு", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["ஆட்டிய",],),],
            ...
            QUnit.test("எழும்பு", t => {
                const expected = new Map([
                    ...
                    ["இறந்தகாலத்துப்பெயரெச்சம்", new Set(["எழுப்பிய",],),],
