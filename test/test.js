        ...
        QUnit.module("உயரும் சொல்லும்", () => {
            ...
            QUnit.test("பயில்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["பயில்வார்",],),],
            ...
            QUnit.test("ஆள்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["ஆள்வார்",],),],
            ...
            QUnit.test("செல்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["செல்வார்",],),],
            ...
            QUnit.test("கொள்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["கொள்வார்",],),],
            ...
            QUnit.test("சொல்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["சொல்வார்",],),],
        ...
        QUnit.module("செய்யும் இடுவும் தகுவும் வாவும் காணும்", () => {
            ...
            QUnit.test("என்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["என்பார்",],),],
            ...
            QUnit.test("உண்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["உண்பார்",],),],
            ...
            QUnit.test("தின்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["தின்பார்",],),],
            ...
            QUnit.test("காண்", t => {
                const expected = new Map([
                    ...
                    ["வருங்காலத்துவினய்முற்று", new Set(["காண்பார்",],),],
