...
அடிப்படய்.ஏவல்வினய்முற்று = அடிப்படய்.அல்வினய்முற்று = அடிப்படய்.எதிர்காலத்துவினயெச்சம் = அடிப்படய்.இறந்தகாலத்துவினயெச்சம் = (_vinay) => "";
அடிப்படய்.இறந்தகாலத்துவினய்முற்று = அடிப்படய்.நிகழ்காலத்துவினய்முற்று = அடிப்படய்.எதிர்காலத்துவினய்முற்று = (vinay) => monosyllabicShortTerminalDoubler(vinay) + "அ" + "ார்";

const அல் = { __proto__: அடிப்படய், இனத்துப்பெயர்: "அல்", };
அல்.valid = (vinay) => vinay == "அல்";
அல்.இறந்தகாலத்துப்பெயரெச்சம் = அல்.நிகழ்காலத்துப்பெயரெச்சம் = அல்.எதிர்காலத்துப்பெயரெச்சம் = (vinay) => vinay + "த்த";
அல்.தொழிற்பெயர் = அடிப்படய்.ஏவல்வினய்முற்று;

const உள் = { __proto__: அடிப்படய், இனத்துப்பெயர்: "உள்", };
உள்.valid = (vinay) => vinay == "உள்";
உள்.இறந்தகாலத்துப்பெயரெச்சம் = உள்.நிகழ்காலத்துப்பெயரெச்சம் = உள்.எதிர்காலத்துப்பெயரெச்சம் = (vinay) => monosyllabicShortTerminalDoubler(vinay) + "அ";

const இல் = { __proto__: அடிப்படய், இனத்துப்பெயர்: "இல்", };
இல்.valid = (vinay) => vinay == "இல்";
இல்.இறந்தகாலத்துப்பெயரெச்சம் = இல்.நிகழ்காலத்துப்பெயரெச்சம் = இல்.எதிர்காலத்துப்பெயரெச்சம் = (vinay) => monosyllabicShortTerminalDoubler(vinay) + "ஆத";
இல்.தொழிற்பெயர் = அடிப்படய்.ஏவல்வினய்முற்று;
...
const vinayinangal = [வாங்கு, பார், உயர், இயல், இரு, இடு, செய், தின், வா, சொல், போ, ஆ, நோ, சா, காண், அல், உள், இல், TBD,];
