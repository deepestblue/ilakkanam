...
வாங்கு.valid = (வினய்) => வினய்.endsWith(u_marker);
...
வா.வினய் = function(வினய்) { return lastAShortener(வினய்) + "ரு"; };
வா.valid = (வினய்) => வினய்.endsWith(A_marker);
...
காண்.இறந்தகாலத்துவினயெச்சம் = (வினய்) => lastAShortener(வினய்) + "து";
...
போ.valid = (வினய்) => [A_letter, A_marker, U_marker, O_marker,].includes(வினய்[வினய்.length - 1]);
...
நோ.valid = (வினய்) => வினய்.endsWith(O_marker);
நோ.இறந்தகாலத்துவினயெச்சம் = (வினய்) => terminalOShortener(வினய்) + "ந்து";

const சா = { __proto__: கடயுயிர், இனத்துப்பெயர்: "சா", };
சா.valid = (வினய்) => வினய்.endsWith(A_marker);
சா.இறந்தகாலத்துவினயெச்சம் = (வினய்) => lastAShortener(வினய்) + "ெத்து";
...
const வினயினங்கள் = [வாங்கு, பார், உயர், இயல், இரு, இடு, செய், தின், வா, சொல், போ, ஆ, நோ, சா, காண், அல், உள், இல், TBD,];
