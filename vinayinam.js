...
const வா = { __proto__: செய், இனத்துப்பெயர்: "வா", வினய்: function(vinay) { return lastAShortener(vinay) + "ரு"; }, };
வா.valid = (vinay) => vinay.endsWith(A_marker);
வா.இறந்தகாலத்துவினயெச்சம் = (vinay) => lastAShortener(vinay) + "ந்து";
வா.எதிர்காலத்துவினயெச்சம் = function(vinay) { return this.வினய்(vinay) + "அ"; };
வா.நிகழ்காலத்துப்பெயரெச்சம் = function(vinay) { return this.வினய்(vinay) + "கின்ற"; };
வா.எதிர்காலத்துவினய்முற்று = function(vinay) { return this.வினய்(vinay) + "வார்"; };
வா.தொழிற்பெயர் = function(vinay) { return this.வினய்(vinay) + "தல்"; };
