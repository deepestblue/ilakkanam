...
export class வினய் {
    constructor(பகுதி, இனம், எழுத்துக்கூட்டுமுறய், byPassCheckForஇனம்MatchingInவினய்Data,) {
        ...
        ({ இனம்: this.வினயினம், தொழிற்பெயர்விதி: this.தொழிற்பெயர்விதி, } = (() => {
            if (இனம்) {
                ...
                if (byPassCheckForஇனம்MatchingInவினய்Data) {
                    return { இனம், தொழிற்பெயர்விதி: undefined, };
                }
                ...
                return { இனம், தொழிற்பெயர்விதி: e.தொழிற்பெயர், };
            }
            ...
            return { இனம்: வினயினத்துData.இனம், தொழிற்பெயர்விதி: வினயினத்துData.தொழிற்பெயர், };
        })());
        ...
        return new Proxy(this, {
            get(target, prop,) {
                ...
                if (prop === "தொழிற்பெயர்") {
                    return () => value.call(target.வினயினம், target.பகுதி, target.தொழிற்பெயர்விதி,);
                }
