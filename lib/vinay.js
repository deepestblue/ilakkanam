...
export class வினய் {
    constructor(பகுதி, இனம், எழுத்துக்கூட்டுமுறய், byPassCheckForஇனம்MatchingInவினய்Data,) {
        ...
        this.வினயினம் = (() => {
            ...
            if (! இனம்) {
                if (! வினயினத்துData) {
                    throw new Error(`“${பகுதி}” எனும் பகுதி அறியாதது.`,);
                }

                if (Array.isArray(வினயினத்துData,)) {
                    const பெயர்கள் = வினயினத்துData.map(இனத்துData => இனத்துData.இனம்.இனத்துப்பெயர்,);
                    throw new Error(`“${பகுதி}” எனும் பகுதிக்கு பல வினயினங்கள் உள்ளன. ${பெயர்கள்.map(v => `“${v}”`,).join(", ",)} என்பவற்றுள் ஒன்றய்த் தேர்ந்தெடுக்க.`, {
            ...
            (() => {
                ...
                if (! Array.isArray(வினயினத்துData,)) {
                    if (வினயினத்துData.இனம் !== இனம்) {
                        throw new Error(`“${பகுதி}” எனும் பகுதி “${இனம்.இனத்துப்பெயர்}” எனும் வினயினத்திற்குச் செல்லாதது.`,);
                    }
                    return;
                }
