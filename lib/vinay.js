    ...
    constructor(வினய்ப்பெயர், இனமோபெயரோ, புத்தெழுத்துமுறயோ,) {
        ...
        return new Proxy(this, {
            get(target, prop,) {
                ...
                // If the property exists on வினயினம், create a forwarding function
                if (typeof target.வினயினம்[prop] === "function") {
                    return function (...args) {
                        return target.வினயினம்[prop](target.வினய்ப்பெயர், ...args,);
                    };
                }

                // Otherwise, return the property from வினயினம் directly
                return target.வினயினம்[prop];
            },
        },);
    }
}
