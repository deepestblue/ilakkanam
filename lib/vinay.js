...
export const இனத்தில்வினய்கள் = இனத்துப்பெயர் => [...வினய்Data.entries(),]
    .filter(([, data,],) => (matcher => (Array.isArray(data,) ? data.some(matcher,) : matcher(data,)))(entry => entry.இனம்.இனத்துப்பெயர் === இனத்துப்பெயர்,),)
    .map(([verb,],) => verb,)
