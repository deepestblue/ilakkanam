    ...
    constructor(பகுதி, இனம், எழுத்துக்கூட்டுமுறய், byPassCheckForஇனம்MatchingInவினய்Data,) {
        ...
        return new Proxy(this, {
            get(target, prop,) {
                ...
                return (...args) => {
                    const பகுதிவிகாரம் = target.வினயினம்.பகுதிவிகாரம்(target.பகுதி, prop,);
                    return new Set([...value.call(target.வினயினம், target.பகுதி, ...args,),].map(விகுதி => பகுதிவிகாரம் + விகுதி,),);
                };
            },
        },);
    }
