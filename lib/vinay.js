...
export class வினய் {
    constructor(வினய்ப்பெயர், இனமோபெயரோ,) {
        ...
        this.வினயினம் = ((வினய்ப்பெயர், இனமோபெயரோ,) => {
            if (இனமோபெயரோ) {
                // If just the name given, lookup by name, else use as‐is
                const வினயினம் = typeof இனமோபெயரோ === 'string' ? வினயினம்byபெயர்(இனமோபெயரோ,) : இனமோபெயரோ;

                if (! வினயினம்.valid(வினய்ப்பெயர்,)) {
                    throw new Error(`வினய் ${வினய்ப்பெயர்} isn't valid for வினயினம் ${இனமோபெயரோ}.`,);
                }
    ...
    அல்வினய்முற்று() {
        return this.வினயினம்.அல்வினய்முற்று(this.வினய்ப்பெயர்);
    }
