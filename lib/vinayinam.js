...
கடயுயிரோரசய்.எதிர்மறய்வினய்முற்று = பகுதி => new Set(கடயுயிரோரசய்.வருங்காலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}${புள்ளி}ஆர்`,),);
...
பார்.எதிர்மறய்வினய்முற்று = function (பகுதி,) { return new Set(பார்.வருங்காலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}${புள்ளி}ஆர்`,),).union(வினயினம்.prototype.எதிர்மறய்வினய்முற்று.call(this, பகுதி,),); };
...
வாங்கு.போனகாலத்துவினய்முற்று = பகுதி => new Set(வாங்கு.போனகாலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}னார்`,),);
...
போது.போனகாலத்துவினய்முற்று = பகுதி => வினயினம்.prototype.போனகாலத்துவினய்முற்று(போது.சிறப்புப்பகுதி(பகுதி,),).union(வாங்கு.போனகாலத்துவினய்முற்று(பகுதி,),);
