...
பார்.எதிர்மறய்வினய்முற்று = function (பகுதி, person, number,) {
    ...
    const prototypeஎதிர்மறய்வினய்முற்று = வினயினம்.prototype.எதிர்மறய்வினய்முற்று.call(this, பகுதி, person, number,);
    if (person === "தன்மய்") {
        if (number === "ஒருமய்") {
...
பார்.வருங்காலத்துவினய்முற்று = function (பகுதி, person, number,) {
    if (person === "தன்மய்") {
        if (number === "ஒருமய்") {
