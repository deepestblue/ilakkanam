import { புள்ளி, ஈLetterஇஈMarkers, ஆLetter, ஆMarker, உMarker, ஊMarker, ஏMarker, ஓMarker, ண்ன்ள்ல்ழ், யரலழள, } from "./ezuttu.js";
...
const ஓரசய்கடயுயிர் = new வினயினம்("ஓரசய்கடயுயிர்",);
ஓரசய்கடயுயிர்.வருங்காலத்துவினயெச்சம் = பகுதி => new Set([`${பகுதி}க`,],);
ஓரசய்கடயுயிர்.எதிர்மறய்வினய்முற்று = function (பகுதி,) { return new Set(this.வருங்காலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}${புள்ளி}ஆர்`,),); };

const போ = Object.create(ஓரசய்கடயுயிர்,);
போ.இனத்துப்பெயர் = "போ";
...
const நோ = Object.create(ஓரசய்கடயுயிர்,);
நோ.இனத்துப்பெயர் = "நோ";
...
const சா = Object.create(ஓரசய்கடயுயிர்,);
சா.இனத்துப்பெயர் = "சா";
...
வாங்கு.போனகாலத்துப்பெயரெச்சம் = function (பகுதி,) { return new Set(this.போனகாலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}ன`,),).union(வினயினம்.prototype.போனகாலத்துப்பெயரெச்சம்.call(this, பகுதி,),); }; // வாங்கின, வாங்கிய
வாங்கு.போனகாலத்துவினய்முற்று = function (பகுதி,) { return new Set(this.போனகாலத்துவினயெச்சம்(பகுதி,).values().map(val => `${val}னார்`,),); }; // வாங்கினார்
...
export { செய், வா, காண், போ, நோ, சா, உயர், சொல், பார், இரு, இடு, தகு, வாங்கு, போது, அல், உள், இல், மாட்டு, };
...
const வினயினங்கள் = [செய், வா, காண், போ, நோ, சா, உயர், சொல், பார், இரு, இடு, தகு, வாங்கு, போது, அல், உள், இல், மாட்டு,];
