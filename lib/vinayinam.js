...
class வினயினம் {
    constructor(இனத்துப்பெயர்,) {
        this.இனத்துப்பெயர் = () => new Set([இனத்துப்பெயர்,],);
    }
    ...
    போனகாலத்துவினய்முற்று(பகுதி, person, number,) {
    ...
    எதிர்மறய்வினய்முற்று(பகுதி, person, number,) {
    ...
    வருங்காலத்துவினய்முற்று(பகுதி, person, number,) {
        ...
        if (person === "தன்மய்") {
            ...
            if (number === "பன்மய்") {
                return new Set(intermediateForms.values().map(val => `${val}வோம்`,),);
            }
            throw new Error(`Invalid number: ${number}`,);
        }
    ...
    நிகழ்காலத்துவினய்முற்று(பகுதி, person, number,) {
        ...
        if (person === "தன்மய்") {
            ...
            if (number === "பன்மய்") {
                return new Set(நிகழ்காலத்துப்பெயரெச்சம்.values().map(val => `${val}${புள்ளி}ஓம்`,),);
            }
            throw new Error(`Invalid number: ${number}`,);
        }
...
வா.ஏவல்வினய்முற்று = (பகுதி, person, number,) => {
...
கடயுயிரோரசய்.எதிர்மறய்வினய்முற்று = (பகுதி, person, number,) => {
    ...
    return new Set([`${baseForm}_கடயுயிரோரசய்_negative_${person}_${number}`,],);
};
கடயுயிரோரசய்.வருங்காலத்துவினய்முற்று = (பகுதி, person, number,) =>
    // TODO: Implement correct Tamil future tense forms for கடயுயிரோரசய் class
    new Set([`${பகுதி}_கடயுயிரோரசய்_future_${person}_${number}`,],);
கடயுயிரோரசய்.தொழிற்பெயர் = பகுதி => new Set([`${பகுதி}தல்`, `${பகுதி}குதல்`,],);
கடயுயிரோரசய்.வியங்கோள்வினய்முற்று = (பகுதி, person, number,) =>
    // வியங்கோள்வினய்முற்று has identical forms in all persons/numbers
...
பார்.வருங்காலத்துவினய்முற்று = (பகுதி, person, number,) =>
    // TODO: Implement correct Tamil future tense forms for பார் class
    new Set([`${பகுதி}_பார்_future_${person}_${number}`,],);
பார்.தொழிற்பெயர் = பகுதி => new Set([`${பகுதி}த்தல்`,],);
பார்.எதிர்மறய்வினய்முற்று = function (பகுதி, person, number,) {
    // TODO: Implement correct Tamil negative forms for பார் class
    return new Set([`${பகுதி}_பார்_negative_${person}_${number}`,],);
};
பார்.வியங்கோள்வினய்முற்று = (பகுதி, person, number,) =>
    // வியங்கோள்வினய்முற்று has identical forms in all persons/numbers
    new Set([`${பகுதி}க்க`,],);
...
வாங்கு.போனகாலத்துவினய்முற்று = (பகுதி, person, number,) =>
    // TODO: Implement correct Tamil past tense forms for வாங்கு class
    new Set([`${பகுதி}_வாங்கு_past_${person}_${number}`,],);
...
போது.போனகாலத்துவினய்முற்று = (பகுதி, person, number,) =>
    // TODO: Implement correct Tamil past tense forms for போது class
    new Set([`${பகுதி}_போது_past_${person}_${number}`,],);
...
சொல்.போனகாலத்துவினய்முற்று = (பகுதி, person, number,) =>
    // TODO: Implement correct Tamil past tense forms for சொல் class
    new Set([`${பகுதி}_சொல்_past_${person}_${number}`,],);

const emptySetGenerator = () => new Set([],);

const அடிப்படய் = new வினயினம்("அடிப்படய்",);
அடிப்படய்.ஏவல்வினய்முற்று = (பகுதி, person, number,) => emptySetGenerator();
அடிப்படய்.எதிர்மறய்வினய்முற்று = (பகுதி, person, number,) => emptySetGenerator();
அடிப்படய்.வருங்காலத்துவினயெச்சம் = பகுதி => emptySetGenerator();
அடிப்படய்.போனகாலத்துவினயெச்சம் = பகுதி => emptySetGenerator();
அடிப்படய்.போனகாலத்துவினய்முற்று = (பகுதி, person, number,) => new Set([`${monosyllabicShortTerminalDoubler(பகுதி,)}ஆர்`,],);
அடிப்படய்.நிகழ்காலத்துவினய்முற்று = (பகுதி, person, number,) => new Set([`${monosyllabicShortTerminalDoubler(பகுதி,)}ஆர்`,],);
அடிப்படய்.வருங்காலத்துவினய்முற்று = (பகுதி, person, number,) => new Set([`${monosyllabicShortTerminalDoubler(பகுதி,)}ஆர்`,],);
