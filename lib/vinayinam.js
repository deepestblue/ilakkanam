...
const போனகாலத்துவினய்முற்றுstub = (பகுதி, இடம், எண்,) => {
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
...
class வினயினம் {
    ...
    போனகாலத்துவினய்முற்று(பகுதி, இடம், எண்,) {
        return போனகாலத்துவினய்முற்றுstub(this.போனகாலத்துப்பெயரெச்சம்(பகுதி,), இடம், எண்,);
    }
    ...
    எதிர்மறய்வினய்முற்று(பகுதி, இடம், எண்,) {
        ...
        if (இடம் === "தன்மய்") {
            if (எண் === "ஒருமய்") {
                return new Set([`${terminalDoubledForm}ஏன்`,],);
            }
            if (எண் === "பன்மய்") {
                return new Set([`${terminalDoubledForm}ஓம்`,],);
            }
            throw new Error(`Invalid எண்: ${எண்}`,);
        }
        if (இடம் === "முன்னிலய்") {
        ...
        if (இடம் === "படர்க்கய்") {
            if (எண் === "ஆண்பால்") {
                return new Set([`${terminalDoubledForm}ஆன்`,],);
            }
            if (எண் === "பெண்பால்") {
                return new Set([`${terminalDoubledForm}ஆள்`,],);
            }
            if (எண் === "பலர்பால்") {
                return new Set([`${terminalDoubledForm}ஆர்`,],);
            }
            if (எண் === "ஒன்றன்பால்") {
    ...
    நிகழ்காலத்துவினய்முற்று(பகுதி, இடம், எண்,) {
        ...
        if (இடம் === "தன்மய்") {
            if (எண் === "ஒருமய்") {
                return new Set([...நிகழ்காலத்துப்பெயரெச்சம்.values().map(val => `${val}${புள்ளி}ஏன்`,), ...நிகழ்காலத்துப்பெயரெச்சம்.values().map(val => `${val}${புள்ளி}அன்`,),],);
            }
            if (எண் === "பன்மய்") {
...
கடயுயிரோரசய்.ஏவல்வினய்முற்று = function (பகுதி, எண்,) {
    if (எண் === "ஒருமய்") {
        return வினயினம்.prototype.ஏவல்வினய்முற்று.call(this, பகுதி, எண்,);
    }
    if (எண் === "பன்மய்") {
...
கடயுயிரோரசய்.எதிர்மறய்வினய்முற்று = (பகுதி, இடம், எண்,) => {
    const வருங்காலத்துவினயெச்சம் = கடயுயிரோரசய்.வருங்காலத்துவினயெச்சம்(பகுதி,);
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஏன்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஓம்`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "முன்னிலய்") {
        if (எண் === "ஒருமய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆய்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஈர்`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "படர்க்கய்") {
        if (எண் === "ஆண்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆன்`,),);
        }
        if (எண் === "பெண்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆள்`,),);
        }
        if (எண் === "பலர்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆர்`,),);
        }
        if (எண் === "ஒன்றன்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆது`,),);
        }
        if (எண் === "பலவின்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆ`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    throw new Error(`Invalid இடம்: ${இடம்}`,);
...
கடயுயிரோரசய்.வருங்காலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => {
    const intermediateForms = [பகுதி, `${பகுதி}கு`,];
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
            return new Set(intermediateForms.map(val => `${val}வேன்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(intermediateForms.map(val => `${val}வோம்`,),).union(new Set(intermediateForms.map(val => `${val}வம்`,),),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "முன்னிலய்") {
        if (எண் === "ஒருமய்") {
            return new Set(intermediateForms.map(val => `${val}வாய்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(intermediateForms.map(val => `${val}வீர்`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "படர்க்கய்") {
        if (எண் === "ஆண்பால்") {
            return new Set(intermediateForms.map(val => `${val}வான்`,),).union(new Set(intermediateForms.map(val => `${val}வன்`,),),);
        }
        if (எண் === "பெண்பால்") {
            return new Set(intermediateForms.map(val => `${val}வாள்`,),).union(new Set(intermediateForms.map(val => `${val}வள்`,),),);
        }
        if (எண் === "பலர்பால்") {
            return new Set(intermediateForms.map(val => `${val}வார்`,),).union(new Set(intermediateForms.map(val => `${val}வர்`,),),);
        }
        if (எண் === "ஒன்றன்பால்") {
            return new Set(intermediateForms.map(val => `${val}வது`,),).union(கடயுயிரோரசய்.வருங்காலத்துப்பெயரெச்சம்(பகுதி,),);
        }
        if (எண் === "பலவின்பால்") {
            return new Set(intermediateForms.map(val => `${val}வன`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    throw new Error(`Invalid இடம்: ${இடம்}`,);
...
பார்.எதிர்மறய்வினய்முற்று = function (பகுதி, இடம், எண்,) {
    ...
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஏன்`,),).union(prototypeஎதிர்மறய்வினய்முற்று,);
        }
        if (எண் === "பன்மய்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஓம்`,),).union(prototypeஎதிர்மறய்வினய்முற்று,);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "முன்னிலய்") {
    ...
    if (இடம் === "படர்க்கய்") {
        if (எண் === "ஆண்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆன்`,),).union(prototypeஎதிர்மறய்வினய்முற்று,);
        }
        if (எண் === "பெண்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆள்`,),).union(prototypeஎதிர்மறய்வினய்முற்று,);
        }
        if (எண் === "பலர்பால்") {
            return new Set(வருங்காலத்துவினயெச்சம்.values().map(val => `${val}${புள்ளி}ஆர்`,),).union(prototypeஎதிர்மறய்வினய்முற்று,);
        }
        if (எண் === "ஒன்றன்பால்") {
...
பார்.வருங்காலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => {
    ...
    if (இடம் === "படர்க்கய்") {
        ...
        if (எண் === "ஒன்றன்பால்") {
            return new Set([`${பகுதி}ப்பது`,],).union(பார்.வருங்காலத்துப்பெயரெச்சம்(பகுதி,),);
        }
        if (எண் === "பலவின்பால்") {
...
சொல்.போனகாலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => போனகாலத்துவினய்முற்றுstub(சொல்.சிறப்புப்போனகாலத்துப்பெயரெச்சம்(பகுதி,), இடம், எண்,).union(வாங்கு.போனகாலத்துவினய்முற்று(பகுதி, இடம், எண்,),);

const emptySetGenerator = () => new Set([],);

const அடிப்படய் = new வினயினம்("அடிப்படய்",);
const அடிப்படய்வினய்முற்றுstub = (பகுதி, இடம், எண்,) => {
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
            return new Set(பகுதி.values().map(val => `${val}ஏன்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(பகுதி.values().map(val => `${val}ஓம்`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "முன்னிலய்") {
        if (எண் === "ஒருமய்") {
            return new Set(பகுதி.values().map(val => `${val}ஆய்`,),);
        }
        if (எண் === "பன்மய்") {
            return new Set(பகுதி.values().map(val => `${val}ஈர்`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "படர்க்கய்") {
        if (எண் === "ஆண்பால்") {
            return new Set(பகுதி.values().map(val => `${val}ஆன்`,),);
        }
        if (எண் === "பெண்பால்") {
            return new Set(பகுதி.values().map(val => `${val}ஆள்`,),);
        }
        if (எண் === "பலர்பால்") {
            return new Set(பகுதி.values().map(val => `${val}ஆர்`,),);
        }
        if (எண் === "ஒன்றன்பால்") {
            return new Set(பகுதி.values().map(val => `${val}அது`,),);
        }
        if (எண் === "பலவின்பால்") {
            return new Set(பகுதி.values().map(val => `${val}அன`,),);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    throw new Error(`Invalid இடம்: ${இடம்}`,);
...
அடிப்படய்.போனகாலத்துவினய்முற்று = அடிப்படய்.வருங்காலத்துவினய்முற்று = அடிப்படய்.நிகழ்காலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => அடிப்படய்வினய்முற்றுstub(new Set([monosyllabicShortTerminalDoubler(பகுதி,),],), இடம், எண்,);
...
அல்.போனகாலத்துவினய்முற்று = அல்.வருங்காலத்துவினய்முற்று = அல்.நிகழ்காலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => அடிப்படய்வினய்முற்றுstub(new Set([`${monosyllabicShortTerminalDoubler(பகுதி,)}ஆது`, `${பகுதி}த்து`,],), இடம், எண்,);
