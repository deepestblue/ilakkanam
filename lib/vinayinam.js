import { புள்ளி, ஈLetterஇஈMarkers, ஆLetter, ஆMarker, உMarker, ஊMarker, ஏMarker, ஓMarker, ண்ன்ள்ல், யரலழள, } from "./ezuttu.js";
...
class வினயினம் {
    ...
    நிகழ்காலத்துப்பெயரெச்சம்(பகுதி,) {
        ...
        if (! match || ! ண்ன்ள்ல்.includes(match[0],)) {
...
const கடயுயிர் = new வினயினம்("கடயுயிர்",);
