...
கடயுயிரோரசய்.வருங்காலத்துவினய்முற்று = (பகுதி, இடம், எண்,) => {
    if (இடம் === "தன்மய்") {
        if (எண் === "ஒருமய்") {
            return new Set([`${பகுதி}வேன்`, `${பகுதி}குவேன்`,],);
        }
        if (எண் === "பன்மய்") {
            return new Set([`${பகுதி}வோம்`, `${பகுதி}குவோம்`, `${பகுதி}வம்`, `${பகுதி}குவம்`,],);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "முன்னிலய்") {
        if (எண் === "ஒருமய்") {
            return new Set([`${பகுதி}வாய்`, `${பகுதி}குவாய்`,],);
        }
        if (எண் === "பன்மய்") {
            return new Set([`${பகுதி}வீர்`, `${பகுதி}குவீர்`,],);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    if (இடம் === "படர்க்கய்") {
        if (எண் === "ஆண்பால்") {
            return new Set([`${பகுதி}வான்`, `${பகுதி}குவான்`, `${பகுதி}வன்`, `${பகுதி}குவன்`,],);
        }
        if (எண் === "பெண்பால்") {
            return new Set([`${பகுதி}வாள்`, `${பகுதி}குவாள்`, `${பகுதி}வள்`, `${பகுதி}குவள்`,],);
        }
        if (எண் === "பலர்பால்") {
            return new Set([`${பகுதி}வார்`, `${பகுதி}குவார்`, `${பகுதி}வர்`, `${பகுதி}குவர்`,],);
        }
        if (எண் === "ஒன்றன்பால்") {
            return new Set([`${பகுதி}வது`, `${பகுதி}குவது`,],).union(கடயுயிரோரசய்.வருங்காலத்துப்பெயரெச்சம்(பகுதி,),);
        }
        if (எண் === "பலவின்பால்") {
            return new Set([`${பகுதி}வன`, `${பகுதி}குவன`,],);
        }
        throw new Error(`Invalid எண்: ${எண்}`,);
    }
    throw new Error(`Invalid இடம்: ${இடம்}`,);
