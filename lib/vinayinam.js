import { புள்ளி, ஈ_letter_இ_ஈ_markers, ஆ_letter, ஆ_marker, உ_marker, ஊ_marker, ஓ_marker, ய_ர_ழ, } from "./ezuttu.js";
import { monosyllabicShortTerminalDoubler, terminalஓShortener, lastஆShortener, } from "./punarcci.js";
...
const இயல் = Object.create(உயர்,);
இயல்.இனத்துப்பெயர் = "இயல்";
...
const தின் = Object.create(செய்,);
தின்.இனத்துப்பெயர் = "தின்";
...
const ஆ = Object.create(போ,);
ஆ.இனத்துப்பெயர் = "ஆ";
ஆ.சிறப்பிறந்தகாலத்துவினயெச்சம் = (வினய்,) => வினய் + "கி";
ஆ.இறந்தகாலத்துவினயெச்சம் = (வினய்,) => new Set([போ.இறந்தகாலத்துவினயெச்சம்(வினய்,), ஆ.சிறப்பிறந்தகாலத்துவினயெச்சம்(வினய்,),],);
ஆ.இறந்தகாலத்துப்பெயரெச்சம் = (வினய்,) => new Set([போ.இறந்தகாலத்துப்பெயரெச்சம்(வினய்,), ஆ.சிறப்பிறந்தகாலத்துவினயெச்சம்(வினய்,) + "அ",],);
...
const அடிப்படய் = Object.create(இயல்,);
...
export {வாங்கு, பார், இரு, உயர், இயல், சொல், செய், இடு, வா, தின், காண், போ, ஆ, நோ, சா, அல், உள், இல், TBD,};

/*
பார் இரு இவய் ஒரு வகய்
உயரும் இயலும் ஒரு வகய்; சொல் இயல் போலவே
செய் தின்னும் ஒரு வகய்; இடுவும் வாவும் செய் போலும்; காண் தின் போலவே
கடயுயிர்கள் ஒரு வகய்
அடிப்படய்கள் ஒரு வகய்
*/

const வினயினங்கள் = [வாங்கு, பார், இரு, உயர், இயல், சொல், செய், இடு, வா, தின், காண், போ, ஆ, நோ, சா, அல், உள், இல்,];
...
export function வினயினம்byபெயர்(இனத்துப்பெயர்,) {
