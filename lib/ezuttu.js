...
export const நெடில்Markers = Object.freeze(["ா", "ீ", "ூ", "ே", "ோ",],);
export const shortToLong = Object.freeze(new Map([["", ஆMarker,], [இMarker, ஈMarker,], [உMarker, ஊMarker,], [எMarker, ஏMarker,], [ஒMarker, ஓMarker,], [அLetter, ஆLetter,], [இLetter, ஈLetter,], [உLetter, ஊLetter,], [எLetter, ஏLetter,], [ஒLetter, ஓLetter,],],),);
