...
export const stopsToNasals = new Map([
...
export const இஈLettersOrMarkers = Object.freeze(["இ", "ஈ", "ி", "ீ",],);
...
export const குறில் = Object.freeze(["அ", "இ", "உ", "எ", "ஒ", "ி", "ு", "ெ", "ொ",],);

export const மெய் = Object.freeze([
    "க", "ங", "ச", "ஞ", "ட", "ண", "ற", "ன", "த", "ந", "ப", "ம",
    "ய", "வ", "ர", "ல", "ள", "ழ",
],);

export const கசதப = Object.freeze(["க", "ச", "த", "ப",],);
export const த = "த";
export const ற = "ற";
export const ட = "ட";
export const ந = "ந";
export const ன = "ன";
export const ண = "ண";
export const ண்ன்ள்ல்ழ் = Object.freeze(["ண்", "ன்", "ள்", "ல்", "ழ்",],);
export const ப = "ப";
export const ல = "ல";
export const ள = "ள";
export const ய = "ய";
export const வ = "வ";
export const இடயினம் = Object.freeze(["ய", "வ", "ர", "ல", "ள", "ழ",],);
