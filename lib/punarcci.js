...
import { vowelsToMarks, மெய், stopsToNasals, புள்ளி, அLetter, ஆLetter, ஆMarker, இLetter, இMarker, ஈLetter, ஈMarker, உLetter, உMarker, ஊLetter, ஊMarker, எLetter, எMarker, ஏLetter, ஏMarker, ஐLetter, ஐMarker, ஒLetter, ஒMarker, ஓLetter, ஓMarker, குறில், கசதப, த, ற, ட, ந, ன, ண, ப, ய, ல, வ, ள, } from "./ezuttu.js";
...
const RE_PUNARCCI12 = RegExp(`${ல}${புள்ளி}${ன}`, "gv",);
const RE_PUNARCCI13 = RegExp(`(${ன}|${ண})${புள்ளி}${வ}`, "gv",);
