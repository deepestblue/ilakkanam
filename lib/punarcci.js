...
import { vowelsToMarks, மெய்Withஅ, stopsToNasals, புள்ளி, அLetter, ஆLetter, ஆMarker, இLetter, இMarker, ஈLetter, ஈMarker, உLetter, உMarker, ஊLetter, ஊMarker, எLetter, எMarker, ஏLetter, ஏMarker, ஐLetter, ஐMarker, ஒLetter, ஒMarker, ஓLetter, ஓMarker, குறில்Letters, குறில்Markers, வல்லினம்Withஅ, க, த, ற, ட, ப, ங, ந, ன, ண, ம, ய, ல, வ, ள, } from "./ezuttu.js";
...
const RE_AIKARAM2 = RegExp(`(.${மெய்WithஅFRAG})${ய}`, "gv",);
