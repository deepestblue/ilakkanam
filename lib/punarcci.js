...
import { vowelsToMarks, consonants, stopsToNasals, புள்ளி, ஆ_letter, ஆ_marker, ஈ_letter_இ_ஈ_markers, உ_letter, உ_marker, ஊ_letter, எ_marker, ஏ_marker, ஒ_letter, ஒ_marker, ஓ_letter, ஓ_marker, குறில், க_ச_த_ப, த, ற, ட, ந, ன, ண, ப, ய, ல, வ, ள, } from "./ezuttu.js";
...
const longToShortVowelMarker = (vowelMarker) => (new Map([[ஏ_marker, எ_marker,], [ஓ_marker, ஒ_marker,],])).get(vowelMarker,);
...
export const புணர்ச்சி = [
    ...
    (s,) => s.replace(
        RegExp(`(${anyOfArray(consonants)}|${ஆ_marker}|${ஆ_letter}|${ஓ_marker}|${ஓ_letter})(${anyOfIterable(vowelsToMarks.keys())})`, "gv",),
