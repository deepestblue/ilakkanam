...
const RE_LAST_STOP_DOUBLER_WITHOUT_NASAL = RegExp(`(${anyOfIterable(stopsToNasals.keys(),)})${உMarker}$`, "v",);
export const lastStopDoublerWithoutNasal = வடிவு => வடிவு.replace(
    RE_LAST_STOP_DOUBLER_WITHOUT_NASAL,
    (_unused, p1,) => p1 + புள்ளி + p1 + உMarker,
);
