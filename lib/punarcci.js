...
import { vowelsToMarks, மெய், stopsToNasals, புள்ளி, அLetter, ஆLetter, ஆMarker, இLetter, இMarker, ஈLetter, ஈMarker, உLetter, உMarker, ஊLetter, ஊMarker, எLetter, எMarker, ஏLetter, ஏMarker, ஐLetter, ஐMarker, ஒLetter, ஒMarker, ஓLetter, ஓMarker, குறில்Letters, குறில்Markers, வல்லினம், க, த, ற, ட, ப, ங, ந, ன, ண, ம, ய, ல, வ, ள, } from "./ezuttu.js";
...
const வல்லினத்து_FRAG = anyOfArray(வல்லினம்,);
...
const RE_PUNARCCI6 = RegExp(`(${ல}|${ள})${புள்ளி}${வல்லினத்து_FRAG}${புள்ளி}`, "gv",);
...
const RE_PUNARCCI14 = RegExp(`${வ}(${வ}${மெய்_FRAG}${புள்ளி})`, "gv",);
