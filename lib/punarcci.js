...
export const புணர்ச்சிவிதிகள்1 = [
    s => s.replace(
    ...
    s => s.replace(
        RegExp(`${வ}${புள்ளி}${அLetter}${வ}(?!${புள்ளி})`, "gv",),
        () => ப + வ,
    ),
];

export const புணர்ச்சிவிதிகள்2 = [
    s => s.replace(
        RegExp(`${புள்ளி}(${VOWEL_KEYS})`, "gv",),
        (_unused, p1,) => vowelsToMarks.get(p1,),
    ),
];
