...
export const புணர்ச்சிவிதிகள் = [
    ...
    s => s.replace(
        RegExp(`(${anyமெய்Withஅ}|${ஆMarker}|${ஆLetter}|${ஊMarker}|${ஊLetter}|${ஓMarker}|${ஓLetter})(${VOWEL_KEYS})`, "gv",),
    ...
    s => s.replace(
        RegExp(`^${ஒLetter}(${VOWEL_KEYS})`, "gv",),
        (_unused, p1,) => ஒLetter + வ + புள்ளி + வ + vowelsToMarks.get(p1,),
    ),
];
