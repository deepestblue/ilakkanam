...
import { vowelsToMarks, consonants, stopsToNasals, புள்ளி, ஆLetter, ஆMarker, ஈLetterஇஈMarkers, உLetter, உMarker, ஊLetter, எMarker, ஏMarker, ஒLetter, ஒMarker, ஓLetter, ஓMarker, குறில், கசதப, த, ற, ட, ந, ன, ண, ப, ய, ல, வ, ள, } from "./ezuttu.js";
...
export const lastStopDoubler = (வினய்,) => {
    const regexp = RegExp(`(?:(${anyOfArray(Array.from(stopsToNasals.values()))})${புள்ளி})?(${anyOfArray(Array.from(stopsToNasals.keys()))})${உMarker}$`,);
