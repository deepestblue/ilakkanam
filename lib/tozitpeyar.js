import { ய, ர, ல, ழ, ள, மெய்Withஅ, } from "./ezuttu.js";
import { lastStopDoublerWithoutNasal, } from "./punarcci.js";
...
const rule10 = rule(பகுதி => {
    if (! [ய, ர, ல, ழ, ள,].some(suffix => பகுதி.endsWith(suffix,),)) {
...
export const தொழிற்பெயர் = { rule1, rule10, rule11, rule12, rule20, };
