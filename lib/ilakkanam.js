...
const schemaObj = {
    ...
    பெயர்ச்சொல்: { label: "பெயர்ச்சொல்", }, // Verbal noun
    எதிர்மறய்ப்பெயர்ச்சொல்: { label: "எதிர்மறய்ப் பெயர்ச்சொல்", }, // Negative verbal noun
...
const buildவடிவுTree = (வினய், எழுத்துக்கூட்டுமுறய், seedGen,) => {
    ...
    treeTraverseAllLeaves(வினய்வடிவு, (node, pathParams,) => {
        ...
        node.வடிவு = (எழுத்துக்கூட்டுமுறய் === "புதியது" ? புணர்ச்சிவிதிகள்.concat(அய்காரத்துப்புதுவிதிகள்,) : புணர்ச்சிவிதிகள்).reduce(
            (intermediateForms, புணர்ச்சிவிதி,) => new Set(Array.from(intermediateForms,).map(புணர்ச்சிவிதி,),),
            seedGen(வினய்[first](...rest,),),
        );
    },);
    return வினய்வடிவு;
};
