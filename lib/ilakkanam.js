...
const buildவடிவுTree = (வினய், எழுத்துக்கூட்டுமுறய்,) => {
    ...
    treeTraverseAllLeaves(வினய்வடிவு, (node, pathParams,) => {
        ...
        const { பகுதி, விகுதிகள், } = வினய்[first](...rest,);
        ...
        node.வடிவு = (எழுத்துக்கூட்டுமுறய் === "புதியது" ? புணர்ச்சிவிதிகள்.concat(அய்காரத்துப்புதுவிதிகள்,) : புணர்ச்சிவிதிகள்).reduce(
            ...
            new Set(Array.from(விகுதிகள்,).map(monosyllabicShortTerminalDoubler.bind(undefined, பகுதி,),),),
        );
    },);
    return வினய்வடிவு;
};
...
export const getForms = (வினய்ப்பெயர், இனத்துப்பெயர், எழுத்துக்கூட்டுமுறய் = "பழயது",) => {
    const வினய்toவடிவு = வினய் => buildவடிவுTree(வினய், எழுத்துக்கூட்டுமுறய்,);
...
export const getவடிவுEndings = இனத்துப்பெயர் =>
    buildவடிவுTree(new வினய்Class("", வினயினம்Byபெயர்(இனத்துப்பெயர்,), "பழயது", true,), "பழயது",);
