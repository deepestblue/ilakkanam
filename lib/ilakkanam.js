...
export const getForms = (வினய்ப்பெயர், இனத்துப்பெயர், புத்தெழுத்துமுறயோ,) => {
    ...
    const generateForms = (வினய்_, வினய்வடிவு,) => treeDFS(
        வினய்வடிவு, (node, pathParams,) => {
    ...
    allForms.children.set("பிறவினய்வடிவு", causativeForms,);
    return allForms;
};
