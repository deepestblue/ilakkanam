...
import { வினய், எழுத்துமுறய்கள், } from "./vinay.js";
...
export { வினய்கள்StartingWith as verbsStartingWith, எழுத்துமுறய்கள் as spellingStyle, } from "./vinay.js";
...
const schemaObj = {
    ...
    வினய்: { label: "வினய்", },
    ஏவல்வினய்முற்று: {
        label: "நேர்மறயேவல் வினய்முற்று", // Positive imperative
        children: {
            ஒருமய்: { label: "ஒருமய்", },
            பன்மய்: { label: "பன்மய்", },
        },
    ...
    தொழிற்பெயர்: { label: "நேர்மறய்த் தொழிற்பெயர்", }, // Positive verbal noun
...
export const getForms = (வினய்ப்பெயர், இனத்துப்பெயர், எழுத்துமுறய் = எழுத்துமுறய்கள்.பழயது,) => {
    const வினய்toவடிவு = வினய்_ => {
        ...
        treeTraverseAllLeaves(வினய்வடிவு, (node, pathParams,) => {
            ...
            node.வடிவு = (எழுத்துமுறய் === எழுத்துமுறய்கள்.புதியது ? புணர்ச்சிவிதிகள்.concat(அய்காரத்துப்புதுவிதிகள்,) : புணர்ச்சிவிதிகள்).reduce(
    ...
    const தன்வினய் = new வினய்(வினய்ப்பெயர், இனத்துப்பெயர் && வினயினம்Byபெயர்(இனத்துப்பெயர்,), எழுத்துமுறய்,);
    const allForms = வினய்toவடிவு(தன்வினய்,);
    allForms.children.set(causativeFormsKey, new Set(getபிறவினய்(தன்வினய், எழுத்துமுறய்,).map(e => வினய்toவடிவு(e,),),),);
    return allForms;
};
