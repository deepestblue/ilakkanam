...
import { வினய், எழுத்துக்கூட்டுமுறய்கள், } from "./vinay.js";
...
export { வினய்கள்StartingWith as verbsStartingWith, எழுத்துக்கூட்டுமுறய்கள் as spellingStyle, } from "./vinay.js";
...
export const getForms = (வினய்ப்பெயர், இனத்துப்பெயர், எழுத்துக்கூட்டுமுறய் = எழுத்துக்கூட்டுமுறய்கள்.பழயது,) => {
    ...
    const தன்வினய் = new வினய்(வினய்ப்பெயர், இனத்துப்பெயர் && வினயினம்Byபெயர்(இனத்துப்பெயர்,), எழுத்துக்கூட்டுமுறய்,);
