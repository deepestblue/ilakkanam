import { புணர்ச்சி, monosyllabicShortTerminalDoubler, } from "./punarcci.js";
...
const schemaObj = {
    ...
    போனகாலத்துப்பெயரெச்சம்: { label: "போனகாலத்துப் பெயரெச்சம்", }, // Past verbal adjective/relative participle
    ...
    வருங்காலத்துப்பெயரெச்சம்: { label: "வருங்காலத்துப் பெயரெச்சம்", }, // Non‐past verbal adjective/relative participle
    ...
    நிகழ்காலத்துப்பெயரெச்சம்: { label: "நிகழ்காலத்துப் பெயரெச்சம்", }, // Present verbal adjective/relative participle
    ...
    const வினய்toவடிவு = வினய்_ => {
        ...
        treeTraverseAllLeaves(வினய்வடிவு, (node, pathParams,) => {
            ...
            node.வடிவு = புணர்ச்சிவிதிகள்.reduce(
                ...
                new Set(Array.from(வினய்_[first](...rest,),).map(monosyllabicShortTerminalDoubler,),),
            );
        },);
        return வினய்வடிவு;
    };
