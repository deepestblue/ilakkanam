...
export const getForms = (வினய்ப்பெயர், இனத்துப்பெயர், புத்தெழுத்துமுறயோ,) => {
    ...
    const வினய்toவடிவு = (வினய்_, புத்தெழுத்துமுறயோ_,) => Array.from(schema.keys(),).reduce(
        (forms, item,) => forms.set(
            item,
            புணர்ச்சி(புத்தெழுத்துமுறயோ_,).reduce(
                (acc, val,) => {
...
export const isRecoverable = e => e.cause === "UserError";
