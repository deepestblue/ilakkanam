...
import { getபிறவினய், } from "./causative.js";
...
function getதன்வினய்Forms(வினய்ப்பெயர், இனத்துப்பெயர்,) {
    if (! வினய்ப்பெயர்) {
        return new Map();
    }
...
function getபிறவினய்Forms(வினய்ப்பெயர், இனத்துப்பெயர்,) {
    if (! வினய்ப்பெயர்) {
        return new Map();
    }

    const பிறவினய் = getபிறவினய்(வினய்ப்பெயர், இனத்துப்பெயர்,);
...
function getForms(வினய்ப்பெயர், இனத்துப்பெயர்,) {
    let allForms = getதன்வினய்Forms(வினய்ப்பெயர், இனத்துப்பெயர்,);

    const பிறவினய்வடிவு = getபிறவினய்Forms(வினய்ப்பெயர், இனத்துப்பெயர்,);
    if (பிறவினய்வடிவு) {
