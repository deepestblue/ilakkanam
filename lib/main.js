...
function getபிறவினய்வடிவு(வினய்ப்பெயர், இனத்துப்பெயர்,) {
...
function getForms(வினய்ப்பெயர், இனத்துப்பெயர்,) {
    ...
    let allForms = வினய்toவடிவு(new வினய்(வினய்ப்பெயர், இனத்துப்பெயர்,),);

    const பிறவினய்வடிவு = getபிறவினய்வடிவு(வினய்ப்பெயர், இனத்துப்பெயர்,);
    if (பிறவினய்வடிவு) {
