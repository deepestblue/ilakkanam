...
import { வாங்கு, பார், உயர், இடு, செய், காண், } from "./vinayinam.js";
import { initialஉLengthener, lastStopDoubler, monosyllabicShortTerminalDoubler, terminalல்Stopper, terminalவுRemover, } from "./punarcci.js";
...
export const rule1 = { generator: (வினய்ப்பெயர்,) => வினய்ப்பெயர், இனம்: (வினயினம்) => {
    if (! [உயர், இடு,].includes(வினயினம்)) {
        throw new Error(`Expecting ${உயர்.இனத்துப்பெயர்} or ${இடு.இனத்துப்பெயர்} இனத்து வினய். Got ${வினயினம்.இனத்துப்பெயர்} instead.`);
    }
    return பார்;
}, };
...
export const rule22 = { generator: (வினய்ப்பெயர்,) => வினய்ப்பெயர் + "பி", இனம்: (வினயினம்) => {
    if (! [செய், காண்,].includes(வினயினம்)) {
        throw new Error(`Expecting ${செய்.இனத்துப்பெயர்} or ${காண்.இனத்துப்பெயர்} இனத்து வினய். Got ${வினயினம்.இனத்துப்பெயர்} instead.`);
    }
    return பார்;
}, };

export const rule30 = { generator: (வினய்ப்பெயர்,) => lastStopDoubler(வினய்ப்பெயர்), இனம்: (வினயினம்) => {
    if (வினயினம் !== வாங்கு) {
        throw new Error(`Expecting ${வாங்கு.இனத்துப்பெயர்} இனத்து வினய். Got ${வினயினம்.இனத்துப்பெயர்} instead.`);
    }
    return வாங்கு;
}, };
