...
import { புணர்ச்சிவிதிகள், penultimateஇஉlengthener, lastStopDoubler, monosyllabicShortTerminalDoubler0, terminalல்ள்Stopper, terminalவுRemover, lastஆMarkerShortener, } from "./punarcci.js";
import { வாங்கு, பார், } from "./vinayinam.js";

export const getபிறவினய் = (தன்வினய், எழுத்துக்கூட்டுமுறய்,) => {
    const { பிறவினய், } = (data => Array.isArray(data,) ? data.find(item => item.இனம்.இனத்துப்பெயர் === தன்வினய்.வினயினம்.இனத்துப்பெயர்,) : data)(வினய்Data.get(தன்வினய்.பகுதி,),);
...
const rule20a = rule20.extend(monosyllabicShortTerminalDoubler0, appender("உ",),);
