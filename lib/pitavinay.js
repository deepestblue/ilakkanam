...
export const getபிறவினய் = (தன்வினய், எழுத்துக்கூட்டுமுறய்,) => {
    const { பிறவினய், } = (data => data.find(item => item.இனம்.இனத்துப்பெயர் === தன்வினய்.வினயினம்.இனத்துப்பெயர்,))(liftToArray(வினய்Data.get(தன்வினய்.பகுதி,),),);

    const byPassCheckForஇனம்MatchingInவினய்Data = true;
    return liftToArray(பிறவினய்,).map(பிறவினய்Rule => new வினய்(
