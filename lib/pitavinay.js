...
import { புணர்ச்சிவிதிகள்1, புணர்ச்சிவிதிகள்2, penultimateஇஉlengthener, lastStopDoubler, monosyllabicShortTerminalDoubler, terminalல்ள்Stopper, terminalவுRemover, } from "./punarcci.js";
...
export const getபிறவினய் = (தன்வினய், எழுத்துக்கூட்டுமுறய்,) => {
    ...
    const ruleToவினய் = பிறவினய்Rule => new வினய்(
        ...
        புணர்ச்சிவிதிகள்1.concat(புணர்ச்சிவிதிகள்2,).reduce(
...
const rule = (generator, இனம்,) => ({ generator, இனம், extend(...fns) {
    return rule(compose(this.generator, ...fns,), this.இனம்,);
}, });

export const rule0 = rule(identity, வினயினம் => வினயினம்,);
export const rule1 = rule(identity, () => பார்,);

export const rule10 = rule(appender("த்து",), () => வாங்கு,);
export const rule10a = rule10.extend(appender("உ",),);
export const rule10b = rule10.extend(penultimateஇஉlengthener,);
export const rule10c = rule10.extend(appender("உ",), terminalல்ள்Stopper,);
export const rule10d = rule10.extend(terminalவுRemover,);
...
export const rule20 = rule(appender("வி",), () => பார்,);
export const rule20a = rule20.extend(monosyllabicShortTerminalDoubler, appender("உ",),);
export const rule21 = { ...rule20, generator: appender("ப்பி",), };

export const rule30 = rule(lastStopDoubler, () => வாங்கு,);
export const rule30a = rule30.extend(appender("பு",), terminalவுRemover,);
